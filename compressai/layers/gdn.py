...
# class Scale_GDN(nn.Module):
#     def __init__(self, in_channels, scale_channel, inverse=False, beta_min=1e-6, gamma_init=0.1,activation='relu',mode="spade"):
#         super().__init__()
...
#         self.adaptivelayer = AdaptiveDeNormalization(in_chan=scale_channel,num_filters=in_channels,mode=mode,activation=activation)
...
#         out = self.adaptivelayer(out,weight)
